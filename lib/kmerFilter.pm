...
my $kmer_genome_file=$out_dir.$kmerFilter_kmer."mer.txt";
my $kmer_fragments_file=$out_dir."fragments_".$kmerFilter_kmer."mer.txt";
my $kmer_distance_file=$out_dir.$kmerFilter_kmer."mer_distance.txt";
my $kmer_filter_file=$out_dir.$kmerFilter_kmer."merFilter.fasta";
my $kmer_filter_name=$kmerFilter_kmer."merFilter.fasta";
my $trf_out_name = $kmerFilter_kmer."merFilter";
